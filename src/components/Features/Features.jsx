...
const Features = () => {
  return (
    <section className="fWrapper">
      <div
        className={`flexColCenter paddings innerWidth  ${styles.fContainer}`}
      >
        <div className={` flexColCenter ${styles.firstSide}`}>
        ...
        <div className={`flexColCenter ${styles.secondSide}`}>
          <div className={`flexColCenter ${styles.card}`}>
